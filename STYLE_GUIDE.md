...
Files                    camelCase       inventoryService.js
...
Brace style                     Opening brace on the same line as declaration
Spaces vs. tabs                 Use spaces only, no tabs
...
Inline comments (when to use)   Use only for complex or non-obvious logic
...
Hotfix branch        hotfix/<short-desc>      hotfix/login-error-fix
